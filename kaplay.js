...
var kaplay = (() => {
  ...
  var su = (t, e) => {
      for (var n in e) xr(t, n, { get: e[n], enumerable: !0 });
    },
    iu = (t, e, n, r) => {
  ...
  var au = (t) => iu(xr({}, "__esModule", { value: !0 }), t);
  var Ao = (() => {
  ...
  var cu = 1103515245,
    ...
    Xt = class {
      ...
      gen() {
        return ((this.seed = (cu * this.seed + lu) % Po), this.seed / Po);
      }
      genNumber(e, n) {
  ...
  function Do(t, e) {
    return t.length <= e ? t.slice() : Tr(t.slice()).slice(0, e);
  }
  function Bo(t) {
  ...
  function jo(t, e) {
    for (let n = 0; n < t.pts.length; n++)
      if (Ar(new Oe(t.pts[n], t.pts[(n + 1) % t.pts.length]), e)) return !0;
  ...
  function Ou(t, e, n, r) {
    let o = 3 * t - 6 * e + 3 * n,
      ...
      m = -t + 3 * e - 3 * n + r;
    if (vr(m, 0)) {
      if (vr(o, 0)) return vr(s, 0) ? [] : [-i / s].filter(Yt);
  ...
  function Vu(t, e, n, r) {
    return wr(t, e, n, r) && wr(t, n, e, r) && wr(t, r, e, n);
  }
  function Pu(t, e, n, r) {
    for (let o of t)
...
`,
  ...
  var gs = (t) => t[0] instanceof j,
    bs = (t) => t[0] instanceof E,
    ys = (t) => typeof t[0] == "number";
  var It = class {
    _items;
    _compareFn;
  ...
  var ws = (t) => t.split(".").slice(0, -1).join(".");
  function Ln(t, e) {
    if (t === e) return !0;
    let n = typeof t,
      r = typeof e;
  ...
  var Cs = new Set(),
    Es = (t) => (t instanceof Error ? t.message : String(t));
  function Du(t) {
  ...
  function Ts(t) {
    return xt(Br(t), 127462, 127487);
  }
  function ju(t) {
    return xt(Br(t), 127988, 127988);
  }
  function Iu(t) {
    return xt(Br(t), 127995, 127999);
  }
  function Ku(t) {
  ...
  function _u(t) {
    ...
    return (
      typeof t == "string" && typeof e == "number" && xt(e, 917504, 917631)
    );
  }
  function Nu(t) {
    ...
    Rs = (t) => {
        ...
        let P = 0,
          ...
          te = (Ae) => {
            ...
            if (((e.realTime = se), (B += Ze), B > Rt)) {
              ...
              ((B = 0), (e.skipTime = !1), e.numFrames++, T(Cn, Ja));
            }
            e.loopID = requestAnimationFrame(te);
          };
        te(0);
      ...
      function eu() {
        for (let f of navigator.getGamepads())
          f && !e.gamepadStates.has(f.index) && wo(f);
      ...
      Me.mousemove = (f) => {
        ...
        if (y()) {
          let B = e.canvas.width / Co,
            te = e.canvas.height / Co,
      ...
      let Eo = ["left", "middle", "right", "back", "forward"];
      ((Me.mousedown = (f) => {
        e.events.onOnce("input", () => {
          let T = Eo[f.button];
          T &&
      ...
      ((Me.keydown = (f) => {
        (tu.has(f.key) && f.preventDefault(),
          e.events.onOnce("input", () => {
            let T = To[f.key] || f.key.toLowerCase(),
              P = f.code;
        ...
        (Me.touchstart = (f) => {
          (f.preventDefault(),
            e.events.onOnce("input", () => {
              ...
              (t.touchToMouse !== !1 &&
                ((e.mousePos = Qe(
                  new E(T[0].clientX - P.x, T[0].clientY - P.y),
                )),
                (e.lastInputDevice = "mouse"),
      ...
      easeInOutElastic: (t) =>
        t === 0
          ...
          : t === 1
            ? 1
            : t < 0.5
              ? -(Math.pow(2, 20 * t - 10) * Math.sin((20 * t - 11.125) * js)) /
                2
              : (Math.pow(2, -20 * t + 10) * Math.sin((20 * t - 11.125) * js)) /
                  2 +
                1,
  ...
  var Ir = class {
    ...
    kn = class {
      ...
      addPolygon(e) {
        let n = new Kr(this._polygons.length),
          r = e.map((o, s) => new Ir(o, e[(s + 1) % e.length], n));
  ...
  function Et(t) {
    return Nr(t).then((e) => e.json());
  }
  function Ns(t) {
    return Nr(t).then((e) => e.text());
  }
  function Us(t) {
    return Nr(t).then((e) => e.arrayBuffer());
  }
  function Hs(t) {
    ...
    static fromImage(e, n = {}) {
      let [r, o] = n.singular
        ...
        s = n.frames
          ...
          : Hr(n.sliceX || 1, n.sliceY || 1, o.x, o.y, o.w, o.h);
      ...
      Array.isArray(e)
        ? e.some((r) => typeof r == "string")
          ? a.assets.sprites.add(
              ...
              Promise.all(
                e.map((r) =>
                  typeof r == "string" ? Tt(r) : Promise.resolve(r),
                ),
              ).then((r) => $s(r, n)),
            )
  ...
  function Hr(t = 1, e = 1, n = 0, r = 0, o = 1, s = 1) {
    let i = [],
      m = o / t,
      u = s / e;
    for (let c = 0; c < e; c++)
  ...
  function qr(t) {
    if (!t) return qr(a.globalOpt.font ?? is);
    if (typeof t == "string") {
      let e = Hn(t),
        n = zr(t);
  ...
  function ei(t, e, n, r, o = {}) {
    ...
    return a.assets.bitmapFonts.add(
      t,
      Tt(s).then((i) => Zs(Ve.fromImage(a.gfx.ggl, i, o), n, r, o.chars ?? Rn)),
    );
  }
  function ti(t, e) {
    return (
        ...
        if (typeof o == "number") n.uniform1f(s, o);
          ...
          ys(o)
            ...
            : bs(o)
              ...
              : gs(o) && n.uniform3fv(s, o.map((m) => [m.r, m.g, m.b]).flat());
  ...
  function qn(t, e = tn, n = nn) {
    let r = ls.replace("{{user}}", e ?? tn),
      o = ms.replace("{{user}}", n ?? nn);
    try {
      return new Wr(
        t,
        r,
  ...
  function xe(t) {
    ...
    if (t.radius) {
      ...
      s = [
        ...
        ...(m[2]
          ? wt(new E(e - m[2], n - m[2]), m[2], m[2], 0, 90)
          : [v(e, n)]),
...
`),
  ...
  function Zr(t, e = !1, n = new Set()) {
    ...
    return (
      ...
      Array.isArray(t) &&
        ((r = [
          "[",
          t.map((s) => Zr(s, !0, n.union(new Set([t])))).join(", "),
          "]",
        ].join("")),
        (t = r)),
      t === null
        ...
        : (typeof t == "object" &&
            ...
            (r += [
              ...
              (o = Object.getOwnPropertyNames(t)
                .map(
                  (s) =>
                    `${/^\w+$/.test(s) ? s : JSON.stringify(s)}: ${Zr(t[s], !0, n.union(new Set([t])))}`,
                )
                .join(", "))
                ? ` ${o} `
                : "",
  ...
  function Ge(t, e, n) {
    return (
      a.game.objEvents.registers[t] ||
        (a.game.objEvents.registers[t] = new rn()),
  ...
  function lo(t = I(255, 255, 255), e = 1) {
  ...
  function Zi(t) {
    return (tt("camRot", "setCamRot / getCamRot"), t !== void 0 && uo(t), co());
  }
  function ea(t = I(255, 255, 255), e = 1) {
    return (tt("camFlash", "flash"), lo(t, e));
  }
  function dn(t = []) {
    let e = new Map(),
      n = [],
      ...
      p = {
        ...
        draw() {
          ...
          (me(),
            (a.gfx.fixed = l),
            this.canvas && (Ce(), this.canvas.unbind()));
        },
        drawInspect() {
          this.hidden ||
            (ge(),
  ...
  function ua(t, e = {}) {
    ...
    let l = (g) => {
        ((o.buffer = g.buf),
          r || ((c = n.currentTime), o.start(0, u), (b = !0)));
      },
      h = si(t);
  ...
  function ca(t) {
    return (tt("volume", "setVolume / getVolume"), t !== void 0 && mo(t), po());
  }
  function cr() {
    (a.app.onHide(() => {
        ...
        if (
          ...
          for (let i = 0; i < this.keys.length - 1; i++) {
            ...
            (this.curves.push(jt(p, m, c, b)),
              s && this.dcurves?.push(jt(p, m, c, b, Zo)));
          }
        }
      }
      update(e, n) {
    ...
    return {
      ...
      animate(o, s, i) {
        ((r = !1),
          this.unanimate(o),
          typeof s[0] == "number"
            ? e.push(new go(o, s, i, t.relative || !1))
            : s[0] instanceof E
              ? e.push(
                  new bo(
                    o,
              ...
              : s[0] instanceof j && e.push(new yo(o, s, i, t.relative || !1)));
      },
      unanimate(o) {
      ...
      add() {
        this.onCollideUpdate("body", (e, n) => {
          ...
          (s && (this.applyBuoyancy(r, s), this.applyDrag(r, s)),
            this.flowMagnitude &&
              r.addForce(
                E.fromAngle(this.flowAngle).scale(this.flowMagnitude),
              ));
        });
      },
      applyBuoyancy(e, n) {
  ...
  function qa(t = {}) {
    ...
    return {
      id: "offscreen",
      require: ["pos"],
      offscreenDistance: t.distance ?? Mr,
      isOffScreen() {
        ...
        let i = this.offscreenDistance ? this.offscreenDistance : Mr;
  ...
  var dc = So.version,
    ...
    Qa = (t = { tagsAsComponents: !0 }) => {
                ...
                if (!F[Xe]) ((F[Xe] = {}), (F[Xe][ct] = [ve]));
                  ...
                  e: for (let Ie of zt) {
                    ...
                    for (let Je of ve.collisionIgnore)
                      if (Ie.is(Je)) continue e;
                    for (let Je of Ie.collisionIgnore)
                      if (ve.is(Je)) continue e;
                    let Wt = rs(ve.worldArea(), Ie.worldArea());
                    if (Wt) {
      ...
      let $e = {
        ...
        rad2deg: lt,
        clamp: Te,
        evaluateQuadratic: Uo,
        evaluateQuadraticFirstDerivative: Ho,
        evaluateQuadraticSecondDerivative: qo,
        evaluateBezier: Jt,
        evaluateBezierFirstDerivative: zo,
        evaluateBezierSecondDerivative: Wo,
        evaluateCatmullRom: Yo,
        evaluateCatmullRomFirstDerivative: $o,
        curveLengthApproximation: Pr,
        normalizedCurve: Xo,
        hermite: Lt,
        cardinal: Gr,
        catmullRom: jt,
